...
/* ---------- Debug/Log (800–811) ---------- */
#define CHAOS_WARN_DEPRECATED_FUNCTION    ((ce_u16)800)
#define CHAOS_WARN_UNOPTIMIZED_PATH       ((ce_u16)801)
#define CHAOS_WARN_UNINITIALIZED_VALUE    ((ce_u16)802)
#define CHAOS_WARN_MEMORY_LEAK            ((ce_u16)803)
#define CHAOS_WARN_PERFORMANCE_DROP       ((ce_u16)804)
#define CHAOS_WARN_PRECISION_LOSS         ((ce_u16)805)
#define CHAOS_EVENT_INFO                  ((ce_u16)806)
#define CHAOS_EVENT_DEBUG                 ((ce_u16)807)
#define CHAOS_EVENT_FRAME_START           ((ce_u16)808)
#define CHAOS_EVENT_FRAME_END             ((ce_u16)809)
#define CHAOS_EVENT_INPUT_RECEIVED        ((ce_u16)810)
#define CHAOS_EVENT_ASSET_RELOADED        ((ce_u16)811)

/* ---------- System/Critical (900–906) ---------- */
#define CHAOS_ERR_FATAL_SIGNAL            ((ce_u16)900)
#define CHAOS_ERR_SHUTDOWN_REQUESTED      ((ce_u16)901)
#define CHAOS_ERR_TIMEOUT                 ((ce_u16)902)
#define CHAOS_ERR_CONFIG_INVALID          ((ce_u16)903)
#define CHAOS_ERR_DEPENDENCY_MISSING      ((ce_u16)904)
#define CHAOS_ERR_INTERNAL_ASSERT         ((ce_u16)905)
#define CHAOS_ERR_PANIC                   ((ce_u16)906)
 ...
 */
static inline ce_result ce_error_emit(ce_error_context* ctx,
                                      ce_u16 category,
                                      ce_u16 severity,
                                      ce_u16 code,
                                      const ce_char* file,
